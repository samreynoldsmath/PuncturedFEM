...
class cell:
    ...
    def is_in_interior(self, x: np.ndarray, y: np.ndarray) -> np.ndarray[bool]:
        """
    ...
    # FUNCTION EVALUATION ####################################################
    def evaluate_function_on_boundary(self, fun: callable):
    ...
    def get_boundary_points(self) -> tuple[np.array, np.array]:
